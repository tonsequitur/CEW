...
function draw() {
  ...
  for (let i = 0; i <= second(); i++) {
    ...
    push();
      translate(40,windowHeight-200);
      textFont('Helvetica');
      textSize(30);
      fill(255);
      text('Arctic-tock',0,40);
      textSize(14);
      textLeading(26);
      fill(200);
      text("The luminescence underwater brightens and darkens diurnally\nLight filters in depending on the angle of the sun in the sky\nAn iceberg moves across the screen over the course of an hour\nPlankton populate once/second and all fade out by the end of a minute",0,70);
}
